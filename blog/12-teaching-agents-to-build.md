<p align="center">
  <img src="../assets/headers/blog-12-teaching-agents.svg" alt="Teaching Agents to Build" width="100%">
</p>
...
Install the nostr-core plugin as npm package:

```
npm install nostr-core
```
https://www.npmjs.com/package/nostr-core
...
**[GitHub](https://github.com/nostr-core-org/nostr-core)** . **[Skills Documentation](https://github.com/nostr-core-org/nostr-core/tree/main/skills)**
